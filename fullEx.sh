...
if [[ "$*" == "-help" ]]; then
     ...
     echo "   -Pspy64/32    Affiche les processus en cours"
     ...
     echo "─────────────────────────────────────────────────"
     echo " "
     echo "   -check-prog    Verifie gcc & python"
     echo "   -perm          Applique les droits d'execution"
     echo "   -shell         Type de shell utilisé"
